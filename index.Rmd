...
>Here we see a scatter plot depicting the countries with the highest level of Covid Testing policies (3), which means taht tests are avaliable to everyone, whether they have symptoms or not. Each dot depicts a country and the number of days this policy has been available. Data for this map was gathered from Our World in Data.